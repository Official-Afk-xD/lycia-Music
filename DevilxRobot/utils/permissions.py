...
from DevilxRobot import pbot as app
from DevilxRobot import DRAGONS, DEV_USERS, WOLVES, DEMONS, TIGERS
from DevilxRobot.utils.adminperms import member_permissions
