...
import DevilxRobot.modules.sql.rules_sql as sql
...
@DevilxRobotcmd(command='rules', filters=Filters.chat_type.groups)
...
@DevilxRobotcmd(command='setrules', filters=Filters.chat_type.groups)
...
@DevilxRobotcmd(command='clearrules', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
