...
from DevilxRobot.modules.helper_funcs.decorators import Asukacmd, Asukamsg
...
@DevilxRobotcmd(command="antichannel", group=100)
...
@DevilxRobotmsg(Filters.chat_type.groups, group=110)
